    ...
    public void shouldChangeSlot() throws ParkingSystemException {
        ...
        doAnswer(
                (args) -> {
                    ...
                    return null;
                }).when(parkingSlotService).updateStatus(givenParkingTicket.getParkingSlot(), SlotStatus.VACANT);
        ...
        doAnswer(
                (args) -> {
                    ...
                    return null;
                }).when(parkingSlotService).updateStatus(changedParkingSlot, SlotStatus.OCCUPIED);
        ...
        doAnswer(
                (args) -> {
                    ...
                    return null;
                }).when(parkingTicketService).updateParkingSlot
